...
run_fun <- function(expression, priors, verbose) {
  data('genesets')
  ...
  scDHA_res <- scDHA(preprocessed$expr, do.clus = T, gen_fil = T, ncores = 2)
...
ti_scTEP_without_pathways <- create_ti_method_r(definition, run_fun, package_loaded = "dplyr")
